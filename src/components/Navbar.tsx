    ...
    <>
      ...
      <div
        className={`sticky top-0 ${
          showShadow && "shadow"
        }  hidden lg:flex items-center justify-between text-black bg-primary  transition-all duration-1000 ease-in-out z-[9999] px-4`}
      >
        ...
        <div className=' flex items-center  '>
          <ul className=' flex items-center justify-between '>
            ...
            <li className='text-white hover:bg-red-500 hover:text-white h-full py-6 px-3 transition-all ease-in-out duration-300 cursor-pointer rounded-sm whitespace-nowrap'>
              <a href='tel:+918886543210' className='no-underline'>
                Call Us: +91-888-654-3210
              </a>
            </li>
          </ul>

          <div className='hidden custom:flex items-center justify-between gap-3 rounded-full py-3 px-6 h-full'>
            <Link to='/wishlist' className=' p-2'>
              <FaBookmark className='text-lg cursor-pointer text-white hover:text-black transition-all duration-300 ease-in-out' />
            </Link>
            <Link to='/cart'>
              <div className='relative group'>
                <IoCart className='text-2xl cursor-pointer text-white group-hover:text-black transition-all duration-300 ease-in-out' />
