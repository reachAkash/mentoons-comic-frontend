...
const Auth = () => {
  ...
  const otpValidationSchema = Yup.object({
    otp0: Yup.string().required("All OTP digits are required"),
    otp1: Yup.string().required("All OTP digits are required"),
    otp2: Yup.string().required("All OTP digits are required"),
    otp3: Yup.string().required("All OTP digits are required"),
  });
                  ...
                  <div className="relative">
                    ...
                    <div className="flex flex-col">
                      <PhoneInput
                        ...
                        className="mt-1 p-2 rounded-md focus:ring-indigo-500 focus:border-indigo-500 w-[12rem] lg:w-[18rem] absolute top-[35%] left-1/2 transform -translate-x-1/2 -rotate-[2deg]"
                      />
                    </div>
                  </div>
              ...
              <div className="relative">
                ...
                <div className="flex flex-col z-10 w-[12rem] lg:w-[18rem] absolute top-[35%] left-1/2 transform -translate-x-1/2">
                  <div className="flex justify-center gap-2 lg:gap-6 lg:pr-7 pr-5" >
                    <Field id="otp0" name="otp0" type="text" maxLength={1} className="w-10 h-10 lg:w-12 lg:h-12 border border-gray-300 rounded-md text-center text-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" />
                    <Field id="otp1" name="otp1" type="text" maxLength={1} className="w-10 h-10 lg:w-12 lg:h-12 border border-gray-300 rounded-md text-center text-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" />
                    <Field id="otp2" name="otp2" type="text" maxLength={1} className="w-10 h-10 lg:w-12 lg:h-12 border border-gray-300 rounded-md text-center text-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" />
                    <Field id="otp3" name="otp3" type="text" maxLength={1} className="w-10 h-10 lg:w-12 lg:h-12 border border-gray-300 rounded-md text-center text-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" />
                  </div>
