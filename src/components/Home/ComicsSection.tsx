...
import podcastSection from "/assets/home/podcastSection.png";
...
const ComicsSection: React.FC = () => {
  ...
  return (
    <div className="relative space-y-10 mt-20 mb-[75rem] md:mb-[125rem] lg:mb-[235rem]">
      ...
      <div className="absolute bottom-[-125%]">
      ...
      <div className="absolute bottom-[-195%]">
