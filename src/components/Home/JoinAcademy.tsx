...
const JoinAcademy = () => {
  ...
  return (
    <div
      className="w-full h-[100vh] flex flex-col lg:flex-row bg-men-blue" >
      <div className="w-full lg:w-1/2 h-[50vh] lg:h-full flex flex-col justify-center items-center bg-black bg-opacity-50 p-8 text-white">
