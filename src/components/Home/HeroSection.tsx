    ...
    <div className="h-[145vh] lg:h-[100vh] py-10 bg-hero-image bg-bottom lg:bg-center bg-contain lg:bg-cover bg-no-repeat">
      <div className="flex flex-col items-center">
        <div className="text-center lg:text-left w-full lg:w-2/4 flex flex-col items-center gap-7 lg:absolute lg:top-1/2 lg:left-10 lg:-translate-y-1/2 pb-[5rem]">
          <div className="flex items-center justify-center w-full md:w-[22rem] mt-20">
            <SearchBar
              input={input}
              setInput={setInput}
          ...
          <p className="text-3xl">
            Those teenagers out there in need of guidance on touchy areas like
            good-touch, bad-touch, dealing with hormonal changes, or breaking
            free from social media, our resources are your rescue.
          </p>
          <div className="flex items-center justify-between gap-4">
            <button
              className="playBtn flex items-center justify-center bg-men-blue text-white p-3 rounded-full"
              onClick={() => setModalOpen(true)}
            >
              <FaPlay className="shadow-xl" />
            </button>
            <span className="text-black lg:text-white text-2xl font-semibold">
              Watch videos
            </span>
          </div>
