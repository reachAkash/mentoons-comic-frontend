...
const DropdownMenu = () => {
  ...
  return (
    <Menubar className='w-[31rem] flex items-center justify-between bg-primary border-none text-white text-base '>
      <MenubarMenu>
        <MenubarTrigger className='cursor-pointer hover:text-white hover:bg-red-500 h-[4.5rem] px-1 text-base'>
          Comics
        </MenubarTrigger>
        <MenubarContent>
      ...
      <MenubarMenu>
        <MenubarTrigger className='cursor-pointer hover:text-white hover:bg-red-500 h-[4.5rem] px-1 text-base whitespace-nowrap'>
          Audio Comics
        </MenubarTrigger>
        <MenubarContent>
          <MenubarSub>
      ...
      <MenubarMenu>
        <MenubarTrigger
          className='cursor-pointer hover:text-white hover:bg-red-500 h-[4.5rem] px-1 text-base '
      ...
      {/* <MenubarMenu>
        <MenubarTrigger className='cursor-pointer hover:text-white hover:bg-red-500 h-[4.5rem] px-1 text-base '>
          <a href='el:+918886543210'>Call Us: +91-888-654-3210</a>
        </MenubarTrigger>
      </MenubarMenu> */}
      {/* <MenubarMenu>
        <MenubarTrigger className='cursor-pointer invisible 2xl:visible hover:text-white hover:bg-red-500 h-[4.5rem] px-6 text-base'>
          Workshops
        </MenubarTrigger>
        <MenubarContent>
