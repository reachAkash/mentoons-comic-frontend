...
// import { login, signup, verifyLoginOTP, verifyOTP } from "@/redux/loginSlice";
...
//   const [step, setStep] = useState<"signup" | "otp" | "login" | "loginOtp">(
//     "signup"
//   );
...
//         toast.success(
//           res.message ||
//             "Login successful. Please enter the OTP sent to your phone."
//         );
//       }
//     } catch (error: any) {
...
//     } catch (error: any) {
//       toast.error(
//         error.message || "Login OTP verification failed. Please try again."
//       );
//     }
//   };
...
//                             onChange={(
//                               e: React.ChangeEvent<HTMLInputElement>
//                             ) => handleOtpChange(e, "otp1", setFieldValue)}
//                             onKeyDown={(
//                               e: React.KeyboardEvent<HTMLInputElement>
//                             ) => handleBackspace(e, null)}
//                           />
//                           <Field
//                             id="otp1"
//                             name="otp1"
...
//                             onChange={(
//                               e: React.ChangeEvent<HTMLInputElement>
//                             ) => handleOtpChange(e, "otp2", setFieldValue)}
//                             onKeyDown={(
//                               e: React.KeyboardEvent<HTMLInputElement>
//                             ) => handleBackspace(e, "otp0")}
//                           />
//                           <Field
//                             id="otp2"
//                             name="otp2"
...
//                             onChange={(
//                               e: React.ChangeEvent<HTMLInputElement>
//                             ) => handleOtpChange(e, "otp3", setFieldValue)}
//                             onKeyDown={(
//                               e: React.KeyboardEvent<HTMLInputElement>
//                             ) => handleBackspace(e, "otp1")}
//                           />
//                           <Field
//                             id="otp3"
//                             name="otp3"
...
//                             onChange={(
//                               e: React.ChangeEvent<HTMLInputElement>
//                             ) => handleOtpChange(e, null, setFieldValue)}
//                             onKeyDown={(
//                               e: React.KeyboardEvent<HTMLInputElement>
//                             ) => handleBackspace(e, "otp2")}
//                           />
//                         </div>
//                       </div>
//                     </div>
  ...
  return (
    <div className="flex  h-screen">
      ...
      <div className="w-[50%] flex items-center justify-center flex-col">
        {isSignUp ? <SignUp signInUrl="#" /> : <SignIn signUpUrl="#" />}
        <button onClick={toggleView} className="mt-4 text-blue-500 underline">
          {isSignUp
