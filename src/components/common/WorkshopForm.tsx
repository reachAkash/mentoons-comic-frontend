    ...
    <div className={`relative ${!isSubmitted ? 'bg-white' : 'bg-transparent'} p-6 rounded-lg max-w-lg mx-auto`}>
      {!isSubmitted ? (
        ...
        <div className="relative inline-block w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg mx-auto">
          <img src="/assets/home/notif.png" alt="Success Image" className="w-full h-full" />
          <div className="absolute inset-0 flex flex-col justify-center items-center text-center p-4 sm:p-6">
            <h2 className="text-2xl font-bold text-men-blue lg:mb-4">Success!</h2>
            <p className="text-lg text-men-blue">Your form has been successfully submitted.</p>
            <button
