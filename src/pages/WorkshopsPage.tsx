...
const WorkshopsPage = () => {
  const [activeWorkShopCategory, setActiveWorkshopCategory] =
    React.useState("6-12");
  const [showForm, setShowForm] = React.useState<boolean>(false);

  const handleActiveWorkShopCategory = (categorylabel: string) => {
    setActiveWorkshopCategory(categorylabel);
  };
  return (
    <section>
      <div className="w-full relative ">
        ...
        <div className=" absolute w-full h-full top-0">
          <div className="flex items-center justify-center pt-12">
            <div
              className=" w-[10%]"
              onClick={() => handleActiveWorkShopCategory("6-12")}
            >
              <img
                src={`/assets/images/${
                  activeWorkShopCategory === "6-12"
            ...
            <div
              className=" w-[10%]"
              onClick={() => handleActiveWorkShopCategory("13-19")}
            >
              <img
                src={`/assets/images/${
                  activeWorkShopCategory === "13-19"
            ...
            <div
              className="w-[14%]"
              onClick={() => handleActiveWorkShopCategory("20+")}
            >
              <img
                src={`/assets/images/${
                  activeWorkShopCategory === "20+"
            ...
            <div
              className=" w-[10%]"
              onClick={() => handleActiveWorkShopCategory("parents")}
            >
              <img
                src={`/assets/images/${
                  activeWorkShopCategory === "parents"
      ...
      {showForm && (
        <Dialog open={showForm} onOpenChange={() => setShowForm(false)}>
          <DialogContent className="z-[999999] bg-transparent border-0">
            ...
            <DialogDescription>
              <WorkshopForm selectedWorkshop={activeWorkShopCategory} />
            </DialogDescription>
          </DialogContent>
        </Dialog>
      )}
