...
const Popup: React.FC<PopupProps> = ({ setShowPopup, item }) => {
  ...
  return (
    <div className="w-screen h-screen bg-black/60 fixed top-0 left-0 flex items-center justify-center z-[999999]">
      <div className="max-w-[25rem] px-2 pt-2 pb-3 rounded-md bg-white backdrop-blur-sm z-[9999] transition-all ease-in-out space-y-2">
        ...
        <div className="px-4 space-y-3">
          ...
          <div className="font-semibold text-lg text-center">
            Congratulations 🎉 You have received {item.name} for free!
            <p className="font-thin text-sm">Kindly check your mail</p>
          </div>
          <div
